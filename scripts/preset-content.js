...
export const presetContent = {
    ...
    "Deep Sleep": {
        ...
        about: [
            ...
            "Most people leave this running all night, either through a speaker or a single earbud. Compared with <a href='/presets/heavy-blanket.html'>Heavy Blanket</a>, which is flat and unmodulated, Deep Sleep has a gentle breathing motion. <a href='/presets/womb-sound.html'>Womb Sound</a> adds grey equalization and pulses more slowly, every twelve and a half seconds."
        ],
    ...
    "Womb Sound": {
        ...
        about: [
            ...
            "Parents often reach for this preset for infants and toddlers, and adults use it when they want the most cushioned sound available. It is close to <a href='/presets/deep-sleep.html'>Deep Sleep</a> but heavier and slower, and next to <a href='/presets/heavy-blanket.html'>Heavy Blanket</a> it adds the rhythmic swell that Heavy Blanket deliberately leaves out."
        ],
    ...
    "Lucid Dream": {
        ...
        about: [
            ...
            "People who find any kind of rhythm distracting tend to choose this over the pulsing sleep presets. It is brighter than <a href='/presets/heavy-blanket.html'>Heavy Blanket</a>, which is full brown with grey EQ, and darker than <a href='/presets/delta-waves.html'>Delta Waves</a>, which sits at 3.6 and has noticeably more hiss. It is a good first pick if you are unsure whether you want a pulse at all."
        ],
    ...
    "Night Cocoon": {
        ...
        about: [
            ...
            "This is a favourite for people who like a hint of motion but found <a href='/presets/deep-sleep.html'>Deep Sleep</a> too obviously rhythmic. <a href='/presets/midnight-hum.html'>Midnight Hum</a> is a close cousin at 3.85 with a slightly faster sixteen-second cycle, while <a href='/presets/slow-descent.html'>Slow Descent</a> stretches the cycle out further to 25 seconds. Try all three at the same volume to hear how much the cycle length changes the feel."
        ],
    ...
    "Drift Away": {
        ...
        about: [
            ...
            "It suits people who find full brown noise too heavy but still want a bedtime sound with some movement. Compared with <a href='/presets/deep-sleep.html'>Deep Sleep</a> it is brighter and cycles slightly slower; compared with <a href='/presets/delta-waves.html'>Delta Waves</a>, which is static at 3.6, it adds the swell while staying only a touch darker."
        ],
    ...
    "Heavy Blanket": {
        ...
        about: [
            ...
            "If you want to fall asleep fast and simply need a wall of low sound, this is usually the first pick. <a href='/presets/deep-brown.html'>Deep Brown</a> in the ambient category is the same color without grey EQ, and <a href='/presets/lucid-dream.html'>Lucid Dream</a> is the closest sleep sibling, sitting at 3.8 without equalization."
        ],
    ...
    "Midnight Hum": {
        ...
        about: [
            ...
            "It is a good middle ground for people who tried <a href='/presets/night-cocoon.html'>Night Cocoon</a> and wanted something a fraction brighter and a little quicker in its cycle. Against <a href='/presets/womb-sound.html'>Womb Sound</a>, which is full brown pulsing every twelve seconds, Midnight Hum is lighter and drifts more slowly. It also works well at very low volume on a bedside speaker."
        ],
    ...
    "Delta Waves": {
        ...
        about: [
            ...
            "This is a popular choice for people who fall asleep well to pink noise but want something a shade warmer for the night. <a href='/presets/lucid-dream.html'>Lucid Dream</a> is the darker unmodulated sibling at 3.8, and <a href='/presets/drift-away.html'>Drift Away</a> is the nearest pulsing option, at 3.7 with a ten-second swell."
        ],
    ...
    "Slow Descent": {
        ...
        about: [
            ...
            "It tends to be picked by people who put the sound on while they are still reading or stretching, rather than at the moment they close their eyes. <a href='/presets/night-cocoon.html'>Night Cocoon</a> has a similar triangle swell on a 20-second cycle with grey EQ, and <a href='/presets/deep-sleep.html'>Deep Sleep</a> is darker and cycles three times as fast."
        ],
    ...
    "Focus Zone": {
        ...
        about: [
            ...
            "This is the default for many people starting a work block. <a href='/presets/deep-work.html'>Deep Work</a> is nearly identical but sits a touch brighter at 3.4, and <a href='/presets/theta-meditation.html'>Theta Meditation</a> uses the same color and EQ with a ten-second fade for a gentler start. If you find yourself adjusting it, the color slider is the first thing to move."
        ],
    ...
    "Study Hall": {
        ...
        about: [
            ...
            "It appeals to people whose main distraction is voices or typing, since higher-pitched masking covers those sounds more efficiently at lower volume. <a href='/presets/beta-boost.html'>Beta Boost</a> is the nearest sibling, warmer at 2.5, and <a href='/presets/concentration.html'>Concentration</a> goes further toward pink at 2.8 with grey EQ and uniform texture."
        ],
    ...
    "Alpha Waves": {
        ...
        about: [
            ...
            "It is a good reference point when you are trying to work out which color you prefer. <a href='/presets/flow-state.html'>Flow State</a> is the same idea at 3.2, a little warmer, and <a href='/presets/standard-pink.html'>Standard Pink</a> in the ambient category is the same color with a one-second fade. See <a href='/physics.html'>the physics page</a> for why pink sounds so even."
        ],
    ...
    "Deep Work": {
        ...
        about: [
            ...
            "People tend to settle on Deep Work when they want slightly more presence than <a href='/presets/focus-zone.html'>Focus Zone</a> without stepping all the way to the brighter <a href='/presets/concentration.html'>Concentration</a>. If you find yourself turning Focus Zone up to cover voices, try this at the same volume first. Both keep the same grey EQ, so the change is purely in the color slider."
        ],
    ...
    "Concentration": {
        ...
        about: [
            ...
            "This preset suits people who find pink too soft and white too sharp. <a href='/presets/beta-boost.html'>Beta Boost</a> is brighter at 2.5 without EQ or texture, and <a href='/presets/deep-work.html'>Deep Work</a> is warmer at 3.4 with the same grey EQ but a smooth Gaussian texture. It also works as a daytime alternative to Coffee Shop when you want the grain without the busyness."
        ],
    ...
    "Beta Boost": {
        ...
        about: [
            ...
            "It is a common pick for short bursts of high-intensity work rather than all-day listening. <a href='/presets/study-hall.html'>Study Hall</a> is brighter still at 1.2, and <a href='/presets/concentration.html'>Concentration</a> is a touch warmer at 2.8 with grey EQ softening the treble. If you start with Beta Boost and find it tiring, moving to Concentration is the usual next step, and from there to Deep Work."
        ],
    ...
    "Flow State": {
        ...
        about: [
            ...
            "It is a natural next step for people who like <a href='/presets/alpha-waves.html'>Alpha Waves</a> but want the treble tucked in slightly. <a href='/presets/focus-zone.html'>Focus Zone</a> is warmer still and adds grey EQ, which some find flatter and some find more even; it is worth trying both back to back."
        ],
    ...
    "Theta Meditation": {
        ...
        about: [
            ...
            "It is used for sitting meditation, breathing practice and yoga more than for desk work, though the underlying sound is the same as <a href='/presets/focus-zone.html'>Focus Zone</a>. If you want motion in the sound, <a href='/presets/breath-work.html'>Breath Work</a> in the experimental category adds a six-second breathing envelope. Many people set it up once and simply leave it as their default for any seated practice."
        ],
    ...
    "Ocean Waves": {
        ...
        about: [
            ...
            "It is the most-used nature preset for both sleep and relaxation. <a href='/presets/waves-loop.html'>Waves Loop</a> in the textured category uses the same envelope at a darker 3.8 without the extra pulse, and <a href='/presets/seaside-cave.html'>Seaside Cave</a> is a slower, boomier twelve-second version with grey EQ. If you fall asleep to it, the wave count is roughly six per minute."
        ],
    ...
    "Heavy Rain": {
        ...
        about: [
            ...
            "People pick this when they want a nature sound that does not draw attention with movement. <a href='/presets/rain-on-tent.html'>Rain on Tent</a> is the nearest sibling, warmer at 3.4 and shaped into gusts with a uniform texture, while <a href='/presets/waterfall.html'>Waterfall</a> is brighter and grittier at 2.8. Many people find it the easiest nature preset to leave on for a whole night."
        ],
    ...
    "Distant Thunder": {
        ...
        about: [
            ...
            "It is popular with people who like storm sounds but want them soft enough to sleep through. <a href='/presets/seaside-cave.html'>Seaside Cave</a> is a smoother, grey-equalized sibling at 3.8, and <a href='/presets/slow-swell.html'>Slow Swell</a> in the textured category is the same brown color with a much gentler 21-second cycle. Of the three, this is the only one with a sharp attack."
        ],
    ...
    "Waterfall": {
        ...
        about: [
            ...
            "It suits people who find rain presets too soft, and those who need a nature sound that covers voices. <a href='/presets/heavy-rain.html'>Heavy Rain</a> is warmer and smoother at 3.3, and <a href='/presets/mountain-wind.html'>Mountain Wind</a> goes even brighter at 1.8 but with gusting rather than a constant roar. Try it during the day rather than at night; it is a lot of sound to sleep through."
        ],
    ...
    "Windy Day": {
        ...
        about: [
            ...
            "It is chosen by people who want a lively sound for daytime rather than sleep. <a href='/presets/mountain-wind.html'>Mountain Wind</a> is much brighter at 1.8 with shorter, sharper gusts, and <a href='/presets/night-forest.html'>Night Forest</a> is the darker, slower sibling at 3.65 with a fourteen-second sway and no envelope. Of the three, Windy Day has the most obvious sense of weather changing."
        ],
    ...
    "Mountain Wind": {
        ...
        about: [
            ...
            "It is a niche pick, used for immersive atmosphere or as a bright masking sound rather than for sleep. <a href='/presets/windy-day.html'>Windy Day</a> is the warmer, slower sibling at 3.1, and <a href='/presets/jet-stream.html'>Jet Stream</a> in the mechanical category is even brighter at 0.8 but steady rather than gusting."
        ],
    ...
    "Rain on Tent": {
        ...
        about: [
            ...
            "It is a favourite for sleep among people who want rain with a little life in it. <a href='/presets/heavy-rain.html'>Heavy Rain</a> is the steady, unshaped version at 3.3, and <a href='/presets/night-forest.html'>Night Forest</a> is darker and slower if you would rather have a still night than a wet one."
        ],
    ...
    "Seaside Cave": {
        ...
        about: [
            ...
            "It is chosen by people who like wave sounds but want them deeper and less busy for sleep. <a href='/presets/ocean-waves.html'>Ocean Waves</a> is the brighter, quicker sibling at 3.2, and <a href='/presets/cave-ambience.html'>Cave Ambience</a> in the textured category adds comb and resonant filtering for a more literal cave echo."
        ],
    ...
    "Pure White": {
        ...
        about: [
            ...
            "It is used mostly by people who already know they like white noise, and by anyone testing headphones or a room. <a href='/presets/grey-noise.html'>Grey Noise</a> is the same color with perceptual EQ applied, and <a href='/presets/standard-pink.html'>Standard Pink</a> is the warmer -3 dB per octave version. The <a href='/physics.html'>physics page</a> explains the maths."
        ],
    ...
    "Standard Pink": {
        ...
        about: [
            ...
            "It is the sensible default for someone who has never used a noise generator before. <a href='/presets/alpha-waves.html'>Alpha Waves</a> in the focus category is identical apart from a longer five-second fade, and <a href='/presets/soft-air.html'>Soft Air</a> is a warmer neighbour at 3.4. If you are unsure where to begin, start here and move the color slider a little each way until it feels right."
        ],
    ...
    "Deep Brown": {
        ...
        about: [
            ...
            "It is popular for sleep, for masking low-frequency noise and for people who find any hiss uncomfortable. <a href='/presets/heavy-blanket.html'>Heavy Blanket</a> is the same color with grey EQ and a longer fade, and <a href='/presets/soft-air.html'>Soft Air</a> is the next step brighter at 3.4. It also serves as the bottom layer in Layered Depths, which blends a blue hiss over the top."
        ],
    ...
    "Blue Sky": {
        ...
        about: [
            ...
            "It is used for masking high-pitched sounds, for dithering experiments and by people who simply prefer a lighter texture. <a href='/presets/violet-haze.html'>Violet Haze</a> is the even brighter sibling at 0.2, and <a href='/presets/tinnitus-mask.html'>Tinnitus Mask</a> is a softened version at 1.5 with grey EQ. Most listeners find it more comfortable in short sessions than as an all-day background sound."
        ],
    ...
    "Violet Haze": {
        ...
        about: [
            ...
            "Few people use this for hours, but it is useful for masking very high-pitched tones and for exploring the extremes of the color scale. <a href='/presets/blue-sky.html'>Blue Sky</a> is a step warmer at 1, and <a href='/presets/asmr-static.html'>ASMR Static</a> in the experimental category tames a similar 0.3 with grey EQ and uniform texture."
        ],
    ...
    "Grey Noise": {
        ...
        about: [
            ...
            "Many people who tried white noise and found it harsh end up here. <a href='/presets/pure-white.html'>Pure White</a> is the untreated version for direct comparison, and <a href='/presets/concentration.html'>Concentration</a> in the focus category applies the same EQ to a slightly warmer 2.8 with uniform texture. See <a href='/physics.html'>the physics page</a> for the equal-loudness idea."
        ],
    ...
    "Soft Air": {
        ...
        about: [
            ...
            "It is a general-purpose choice for people who want a comfortable background at any time of day. <a href='/presets/standard-pink.html'>Standard Pink</a> is the slightly brighter reference at 3, and <a href='/presets/deep-brown.html'>Deep Brown</a> is the full-bass extreme at 4. <a href='/presets/box-fan.html'>Box Fan</a> is a similar color with grey EQ and grainier texture."
        ],
    ...
    "Coffee Shop": {
        ...
        about: [
            ...
            "It appeals to people who work best with a sense of activity around them but find real cafe recordings distracting. <a href='/presets/concentration.html'>Concentration</a> is the closest focus-category sibling at 2.8 with grey EQ, and <a href='/presets/waterfall.html'>Waterfall</a> is the same grainy idea at a brighter 2.8 without EQ. It is also a decent bridge for people moving from music to noise while working."
        ],
    ...
    "Airplane Cabin": {
        ...
        about: [
            ...
            "It is a favourite for people who sleep well on planes and want to recreate that feeling at home. <a href='/presets/box-fan.html'>Box Fan</a> is brighter at 3.3 with a grainier texture, and <a href='/presets/jet-stream.html'>Jet Stream</a> is the outside-the-aircraft version, far brighter at 0.8. It also works well as an all-day office sound, since the balance is easy on the ears for long stretches."
        ],
    ...
    "Box Fan": {
        ...
        about: [
            ...
            "This is the most common sleep sound in the world for a reason, and many people use this preset to replace an actual fan in winter. <a href='/presets/airplane-cabin.html'>Airplane Cabin</a> is the smoother, slightly warmer sibling, and <a href='/presets/cpu-fan.html'>CPU Fan</a> is a much brighter, whinier small fan at 1.3."
        ],
    ...
    "Space Station": {
        ...
        about: [
            ...
            "It is picked for sleep and for people who like a science-fiction feel to their background sound. <a href='/presets/submarine.html'>Submarine</a> is a close cousin with an envelope loop instead of a pulse, and <a href='/presets/spaceship-hull.html'>Spaceship Hull</a> in the textured category adds comb and resonant filters for a metallic ring."
        ],
    ...
    "Server Room": {
        ...
        about: [
            ...
            "It suits people who work in or near technical spaces and find that sound oddly calming, and those who need a bright mask for high-pitched distractions. <a href='/presets/cpu-fan.html'>CPU Fan</a> is a grainier single-fan version at 1.3, and <a href='/presets/tinnitus-mask.html'>Tinnitus Mask</a> in the ambient category is nearly the same color at 1.5 with uniform texture."
        ],
    ...
    "CPU Fan": {
        ...
        about: [
            ...
            "It is chosen by people who are used to working next to a laptop and find silence odd without it. <a href='/presets/server-room.html'>Server Room</a> is the same idea multiplied into a whole rack at 1.6 with smoother Gaussian texture, and <a href='/presets/box-fan.html'>Box Fan</a> is the large, warm domestic fan at 3.3."
        ],
    ...
    "Furnace": {
        ...
        about: [
            ...
            "It suits people who like the feel of a heating system cycling on a cold night. <a href='/presets/diesel-engine.html'>Diesel Engine</a> is the faster, darker mechanical throb at 4, and <a href='/presets/distant-thunder.html'>Distant Thunder</a> in the nature category is a similar slow-cycle brown sound with a much softer attack. It is a daytime and evening sound more than an overnight one."
        ],
    ...
    "Submarine": {
        ...
        about: [
            ...
            "It is a sleep favourite for people who want the darkest sound available with some motion in it. <a href='/presets/space-station.html'>Space Station</a> is the same color range with a single slow pulse and no envelope, and <a href='/presets/deep-sleep.html'>Deep Sleep</a> in the sleep category is nearly the same color with a quicker eight-second swell."
        ],
    ...
    "Electric Hum": {
        ...
        about: [
            ...
            "It is mostly used for sound design and by people who find the buzz of old electrics oddly soothing. <a href='/presets/diesel-engine.html'>Diesel Engine</a> is the low, chugging equivalent, and <a href='/presets/static-tv.html'>Static TV</a> in the experimental category is a faster, brighter version of the same gated idea at white."
        ],
    ...
    "Jet Stream": {
        ...
        about: [
            ...
            "It is picked for masking very high-pitched sounds and for people who like a bright, open hiss for daytime alertness. <a href='/presets/airplane-cabin.html'>Airplane Cabin</a> is the inside-the-plane version at 3.5, and <a href='/presets/mountain-wind.html'>Mountain Wind</a> in the nature category is a gusting sibling at 1.8. Most people use it in short sessions rather than for hours at a time."
        ],
    ...
    "Static TV": {
        ...
        about: [
            ...
            "This is a sound-design and novelty preset rather than a sleep aid. <a href='/presets/electric-hum.html'>Electric Hum</a> in the mechanical category is the slower, warmer gated cousin, and <a href='/presets/machine-rhythm.html'>Machine Rhythm</a> layers four independent gated voices for a more complex industrial pattern. Turn the volume down before pressing play; it arrives instantly and at full intensity, with a fade-in of only two hundredths of a second."
        ],
    ...
    "Vinyl Crackle": {
        ...
        about: [
            ...
            "It is layered under music or podcasts by people who like a lo-fi feel, and used alone as a very light bedtime texture. <a href='/presets/asmr-static.html'>ASMR Static</a> is the steady, grey-equalized version at 0.3, and <a href='/presets/lo-fi-crunch.html'>Lo-Fi Crunch</a> in the textured category gets its grit from bit-reduction rather than color."
        ],
    ...
    "Cicadas": {
        ...
        about: [
            ...
            "It is popular for summer atmosphere and for people who grew up with the sound. <a href='/presets/wind-chimes.html'>Wind Chimes</a> in the textured category uses resonant filters on a similar color but at musical pitches with a slow envelope, and <a href='/presets/mountain-wind.html'>Mountain Wind</a> is the same brightness without the tonal ring."
        ],
    ...
    "ASMR Static": {
        ...
        about: [
            ...
            "It is used at low volume for tingles, for masking very quiet rooms, and as a texture under recorded whispers. <a href='/presets/violet-haze.html'>Violet Haze</a> in the ambient category is the raw, unequalized sibling at 0.2, and <a href='/presets/vinyl-crackle.html'>Vinyl Crackle</a> is the same brightness shaped into a crackle rhythm."
        ],
    ...
    "Breath Work": {
        ...
        about: [
            ...
            "It is used for paced breathing, meditation and settling before sleep. <a href='/presets/breathing.html'>Breathing</a> in the textured category is the same envelope at 3.5 without the extra pulse, and <a href='/presets/breathing-room.html'>Breathing Room</a> layers three breathing voices of different lengths with reverb. Many people use it as a five-minute reset between tasks rather than as a long background sound."
        ],
    ...
    "Machine Rhythm": {
        ...
        about: [
            ...
            "This is a sound-design and creative preset rather than a sleep sound. <a href='/presets/static-tv.html'>Static TV</a> is the single-voice gated ancestor, and <a href='/presets/pulse-rhythm.html'>Pulse Rhythm</a> in the textured category is a single clean gated voice at 2.5 with grey EQ and no bit reduction. Because the voices live in the generator, you can mute or retune any of them while it runs."
        ],
    ...
    "Tibetan Bowl": {
        ...
        about: [
            ...
            "It is used for meditation timing, yoga transitions and as a gentle wake-up tone. <a href='/presets/wind-chimes.html'>Wind Chimes</a> uses the same struck idea with higher, major-chord pitches and a faster cycle, and <a href='/presets/resonant-drone.html'>Resonant Drone</a> sustains a lower tone instead of striking it. At low volume it is unobtrusive enough to run through an entire sitting without pulling focus."
        ],
    ...
    "Metal Wind": {
        ...
        about: [
            ...
            "It is a sound-design and atmosphere preset more than a relaxation one. <a href='/presets/hollow-tube.html'>Hollow Tube</a> uses a longer 8 millisecond comb for a lower, woodier tone, and <a href='/presets/mountain-wind.html'>Mountain Wind</a> in the nature category is the same gusting idea without any filtering. Try it under a darker preset for a hint of metal without giving up the low end."
        ],
    ...
    "Hollow Tube": {
        ...
        about: [
            ...
            "It is useful as a tonal bed for ambient music and for people who find the pipe-like character calming. <a href='/presets/metal-wind.html'>Metal Wind</a> is the brighter, harsher comb relative at 3 milliseconds, and <a href='/presets/singing-pipes.html'>Singing Pipes</a> gets a similar pipe tone from resonant bandpass filters instead. Because the cycle is short, it feels more like a steady drone than a rhythm."
        ],
    ...
    "Spaceship Hull": {
        ...
        about: [
            ...
            "It is a favourite for sleep among science-fiction fans and for anyone who likes a low tonal element. <a href='/presets/space-station.html'>Space Station</a> in the mechanical category is the unfiltered version, and <a href='/presets/cave-ambience.html'>Cave Ambience</a> uses a similar comb and resonant recipe at full brown with a longer 16-second cycle."
        ],
    ...
    "Wind Chimes": {
        ...
        about: [
            ...
            "It is used for gentle wake-up alarms, garden atmosphere and as a light tonal texture. <a href='/presets/tibetan-bowl.html'>Tibetan Bowl</a> is the lower, slower struck sibling at 256 Hz, and <a href='/presets/cicadas.html'>Cicadas</a> in the experimental category uses resonant filters on a similar color for a buzzing insect chorus instead."
        ],
    ...
    "Cave Ambience": {
        ...
        about: [
            ...
            "It suits sleep, meditation and anyone who wants the darkest textured preset. <a href='/presets/seaside-cave.html'>Seaside Cave</a> in the nature category is the unfiltered, wetter cousin at 3.8, and <a href='/presets/spaceship-hull.html'>Spaceship Hull</a> is the same filter recipe tuned brighter and more metallic. Of the three it is the darkest and slowest, and the most likely to disappear into the background over a long night."
        ],
    ...
    "Breathing": {
        ...
        about: [
            ...
            "It is used for paced breathing and for settling into sleep alongside a partner who is already asleep. <a href='/presets/breath-work.html'>Breath Work</a> in the experimental category is the same envelope at 3.2 with an extra slow swell, and <a href='/presets/breathing-room.html'>Breathing Room</a> spreads three breathing voices across the stereo field."
        ],
    ...
    "Pulse Rhythm": {
        ...
        about: [
            ...
            "It suits people who like a rhythmic anchor without the aggression of the mechanical presets. <a href='/presets/diesel-engine.html'>Diesel Engine</a> is the darker, faster chug at full brown, and <a href='/presets/machine-rhythm.html'>Machine Rhythm</a> in the experimental category multiplies this idea into four interlocking gated voices. At low volume it can also serve as a loose timekeeper for slow breathing or walking."
        ],
    ...
    "Slow Swell": {
        ...
        about: [
            ...
            "It is used for sleep and for slow breathing practice at a very relaxed pace. <a href='/presets/distant-thunder.html'>Distant Thunder</a> in the nature category is the same brown color with a fast attack and a much shorter cycle, and <a href='/presets/deep-sleep.html'>Deep Sleep</a> gets a similar slow motion from a pulse rather than an envelope."
        ],
    ...
    "Drifting": {
        ...
        about: [
            ...
            "It is popular on headphones for sleep and for people who find a fixed centre image fatiguing. <a href='/presets/focus-zone.html'>Focus Zone</a> in the focus category is the same color with grey EQ and no panning, and <a href='/presets/stereo-clouds.html'>Stereo Clouds</a> pairs two separately panned voices with reverb for a wider, more diffuse motion."
        ],
    ...
    "Layered Depths": {
        ...
        about: [
            ...
            "It is chosen by people who want the mass of brown noise with enough treble to mask voices and keyboards. <a href='/presets/deep-brown.html'>Deep Brown</a> in the ambient category is the bottom layer alone, and <a href='/presets/tinnitus-mask.html'>Tinnitus Mask</a> is close to the top layer alone with grey EQ added."
        ],
    ...
    "Warm Hiss": {
        ...
        about: [
            ...
            "It suits people who like a bright noise for focus but find white or blue tiring after an hour. <a href='/presets/beta-boost.html'>Beta Boost</a> in the focus category is the same color without saturation, and <a href='/presets/lo-fi-crunch.html'>Lo-Fi Crunch</a> takes a different route to warmth through bit reduction rather than saturation."
        ],
    ...
    "Lo-Fi Crunch": {
        ...
        about: [
            ...
            "It is used for retro game and music sound design and by people who simply like the texture. <a href='/presets/warm-hiss.html'>Warm Hiss</a> is the analogue-flavoured alternative using saturation, and <a href='/presets/machine-rhythm.html'>Machine Rhythm</a> in the experimental category applies a milder 10-bit crush to a four-voice rhythm. It sits well under chiptune or lo-fi beats where a clean noise would sound out of place."
        ],
    ...
    "Cathedral Air": {
        ...
        about: [
            ...
            "It is chosen for meditation, sleep, and anyone who finds dry noise too close to the ear. <a href='/presets/focus-zone.html'>Focus Zone</a> in the focus category is exactly this sound without the reverb, and <a href='/presets/stereo-clouds.html'>Stereo Clouds</a> uses a similar large reverb with two panned voices for a wider, more mobile space."
        ],
    ...
    "Ocean Drift": {
        ...
        about: [
            ...
            "It is the preset to try when a single looping wave starts to feel mechanical. <a href='/presets/waves-loop.html'>Waves Loop</a> is one of these voices on its own, and <a href='/presets/ocean-waves.html'>Ocean Waves</a> in the nature category is brighter and uses a pulse rather than extra voices for its added motion."
        ],
    ...
    "Breathing Room": {
        ...
        about: [
            ...
            "It suits group meditation, sleep, and people who found a single breathing loop too regimented. <a href='/presets/breathing.html'>Breathing</a> is the centre voice on its own, and <a href='/presets/breath-work.html'>Breath Work</a> in the experimental category is a single breath at 3.2 with an added slow swell. The stereo spread means it works best on headphones or a well-separated pair of speakers."
        ],
    ...
    "Stereo Clouds": {
        ...
        about: [
            ...
            "It is designed for headphones and long sessions where a static image gets tiring. <a href='/presets/drifting.html'>Drifting</a> is a single voice with faster, deeper panning and no reverb, and <a href='/presets/cathedral-air.html'>Cathedral Air</a> is a single grey-equalized voice in a similar large space without the motion. Because both voices are pink-range, the tone stays soft no matter where the balance sits."
        ],
